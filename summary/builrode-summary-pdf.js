/*! Builrode enquiry-summary PDF 1.0.1 — A4, Inter embedded, dark closing band.
    ...
    for (let p = 1; p <= pages; p++) {
      ...
      if (!last) {
        ...
        if (p === 1) {
          ...
          font('InterSemi', 11, C.green); T(BUSINESS_WA_TEXT, ex, ey);
          doc.link(ex - 8, ey - 14, doc.getTextWidth(BUSINESS_WA_TEXT) + 16, 20, { url: wa });
        }
        continue;
      }
      const r1 = top + 24;
      ...
      font('InterSemi', 12.5, C.waDark); T(BUSINESS_WA_TEXT, M + 19, ny);
